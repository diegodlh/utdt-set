...
jsPsych.plugins.video = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    video_html += `
      <img id="video-next" src="images/next.png?v=__VERSION__" style="position:absolute;right:10px;top:50%;transform:translateY(-50%);width:10%;visibility:hidden" />
      <img id="video-back" src="images/repeat.png?v=__VERSION__" style="position:absolute;left:0;bottom:0;visibility:hidden">
